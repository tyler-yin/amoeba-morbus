...
int VAL = 20;
int RESET = 1800; 
float SCOPE_SIZE = 0.5;    // 1.0 for fullscreen, 0.5 for 1280 x 720
...
void draw() {
  ...
  if (!mousePressed) {
    pushMatrix();
    scale(SCOPE_SIZE); // if DISPLAY is not fullscreen
    shape(scope, 0, 0);
    popMatrix();
  } 
  ...
  // Data
  textSize(10.5);
  text("sensor :", 2.75*width/4 + 50, 1.75*height/2 - 60);
  text(avgMotion, 2.75*width/4 + 90, 1.75*height/2 - 45); //totalMotion
  text("threat :", 2.75*width/4 + 50, 1.75*height/2 - 30);
  text(virusVel, 2.75*width/4 + 90, 1.75*height/2 - 15);
  text(virusMotion, 2.75*width/4 + 90, 1.75*height/2);
  text("lifespan :", 2.75*width/4 + 50, 1.75*height/2 + 15);
  text(counter, 2.75*width/4 + 90, 1.75*height/2 + 30);
  text("morbus :", 2.75*width/4 + 50, 1.75*height/2 + 45);
  if (trigger == true) text("ON", 2.75*width/4 + 90, 1.75*height/2 + 60);
  else text("OFF", 2.75*width/4 + 90, 1.75*height/2 + 60);
